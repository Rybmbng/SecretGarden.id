...
<section class="relative w-full bg-[white] text-black font-sans">
  ...
  <div class="relative h-[80vh] overflow-hidden">
    <img src="<?= base_url('assets/SGV/service-banner.jpg') ?>" alt="Service Banner" class="w-full h-full object-cover" />
    <div class="absolute inset-0 flex items-center justify-center">
      <h1 class="text-4xl md:text-6xl font-light tracking-wide">Our Service</h1>
    </div>
  </div>

  <!-- Description -->
  <div class="max-w-4xl mx-auto px-6 py-16 text-center space-y-6">
    <h2 class="text-2xl md:text-3xl tracking-wider uppercase text-black">A Thoughtful Experience</h2>
  ...
  <div class="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10 py-12">
    <div class="group">
      <div class="overflow-hidden rounded-2xl">
        <img src="<?= base_url('assets/SGV/service1.jpg') ?>" alt="Packaging Service" class="w-full h-64 object-cover transition-transform duration-700 group-hover:scale-105" />
      </div>
    ...
    <div class="group">
      <div class="overflow-hidden rounded-2xl">
        <img src="<?= base_url('assets/SGV/service2.jpg') ?>" alt="Delivery Service" class="w-full h-64 object-cover transition-transform duration-700 group-hover:scale-105" />
      </div>
    ...
    <div class="group">
      <div class="overflow-hidden rounded-2xl">
        <img src="<?= base_url('assets/SGV/service3.jpg') ?>" alt="Customer Support" class="w-full h-64 object-cover transition-transform duration-700 group-hover:scale-105" />
      </div>
