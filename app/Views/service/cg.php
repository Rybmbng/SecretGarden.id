...
<section class="relative w-full bg-[white] text-black font-sans">
  ...
  <div class="max-w-4xl mx-auto px-6 py-16 text-center">
    <h3 class="text-xs font-bold mb-0 md:text-s tracking-wider uppercase text-black">SecretGarden.ID</h3>
    <h1 class="text-2xl md:text-3xl tracking-wider uppercase text-black mb-6">Coorporate Gift</h1>
    <h2 class="text-xl font-bold md:text-1xl tracking-wider uppercase text-black mb-2">A Thoughtful Experience</h2>
    <p class="text-lg leading-relaxed text-black-300 mb-2">
  ...
  <!-- Service List -->
  <div class="max-w-6xl mx-auto text-center px-6 grid grid-cols-1 md:grid-cols-3 gap-10 py-12">
    <div class="group">
  ...
  <div class="text-center py-16">
    ...
    <a href="<?= base_url('services/cu') ?>" class="inline-block px-6 py-3 border border-[#c9ac6c] text-[#c9ac6c] hover:bg-[#c9ac6c] hover:text-black transition duration-300 rounded-full">
      Contact Us
    </a>
  </div>
</section>
