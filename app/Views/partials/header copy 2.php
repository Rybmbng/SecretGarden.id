 ...
 <body class="overflow-y-scroll parallax">
  <nav class="fixed top-0 left-0 w-full z-50 bg-white/95 backdrop-blur-sm shadow-sm">
   <div class="max-w-7xl mx-auto relative h-16 flex items-center px-6">
    ...
    <div id="menu" class="hidden md:flex space-x-8 text-black text-sm font-semibold tracking-wide mx-auto">
     <ul class="flex items-center space-x-1 cursor-pointer select-none">
      <span>PRODUCTS</span>
      <i class="fas fa-chevron-down text-black text-xs"></i>
      <li>ss</li>
    </ul>
     <ul class="flex items-center cursor-pointer select-none">STORY</ul>
     <ul class="flex items-center space-x-1 cursor-pointer select-none">
      <span>LEARN</span>
      <i class="fas fa-chevron-down text-black text-xs"></i>
      <ul>ss</ul>
   ...
   <div id="mobile-menu" class="md:hidden hidden bg-white/95 backdrop-blur-sm shadow-md absolute top-full left-0 w-full z-40 m-0">
