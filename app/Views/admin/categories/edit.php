...
<div class="max-w-7xl mx-auto px-6 py-10 bg-gradient-to-br from-white via-amber-50 to-amber-100 min-h-screen">

  <div class="flex items-center justify-between mb-8">
    <h2 class="text-3xl font-serif font-semibold text-amber-800 tracking-wide drop-shadow-sm">Category List</h2>
    <button id="openCreateBtn" 
      class="inline-flex items-center bg-gradient-to-r from-amber-600 via-amber-700 to-amber-800 text-white font-semibold px-5 py-2 rounded-full shadow hover:shadow-lg transition-transform duration-300 hover:scale-[1.05]">
      + Add Category
    </button>
  </div>
