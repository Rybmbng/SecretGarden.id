...
<body class="bg-gray-50 text-black font-sans antialiased" x-data="sidebar()" x-init="init()">
  ...
  <div class="flex items-center space-x-4">
    ...
    <div class="relative" x-data="{ open: false }">
      <button @click="open=!open" class="flex items-center space-x-2 focus:outline-none">
        ...
        <img src="<?= base_url(session()->get('user')['avatar'] ?? 'assets/SGV/avatar/default.png') ?>" alt="Avatar" class="h-8 w-8 rounded-full border-2 border-gray-200 object-cover shadow-sm">
    ...
    function renderDockMenu($menus) {
        foreach ($menus as $m) {
            ...
            if ($hasChildren) {
                ...
                echo '<i class="fas fa-chevron-right ml-auto text-black" x-show="expanded" x-transition.opacity.duration.300ms></i>';
                echo '</button>';
