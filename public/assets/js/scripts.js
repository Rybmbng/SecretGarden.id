    ...
    var c = /\blang(?:uage)?-([\w-]+)\b/i
      ...
      , C = {
            ...
            DFS: function e(r, n, t, a) {
                ...
                for (var o in r)
                    if (r.hasOwnProperty(o)) {
                        ...
                        var l = r[o]
                          , s = C.util.type(l);
                        "Object" !== s || a[i(l)] ? "Array" !== s || a[i(l)] || (a[i(l)] = !0,
                        e(l, n, o, a)) : (a[i(l)] = !0,
                        e(l, n, null, a))
                    }
            }
        ...
        highlightElement: function(e, r, n) {
            ...
            if (C.hooks.run("before-highlight", o),
            o.grammar)
                if (r && u.Worker) {
            ...
            for (var l in n)
                if (n.hasOwnProperty(l) && n[l]) {
                    ...
                    for (var u = 0; u < s.length; ++u) {
                        ...
                        c = c.pattern || c;
                        for (var y = t, v = a; y < r.length; v += r[y].length,
                        ++y) {
                            var k = r[y];
                            ...
                            if (!(k instanceof _)) {
                                ...
                                if (S) {
                                    ...
                                    1 != O && C.matchGrammar(e, r, n, y, v, !0, l + "," + u),
                                    i)
                                        break
                                } else if (i)
                                    break
        ...
        tokenize: function(e, r) {
            ...
            return C.matchGrammar(e, n, r, 0, 0, !1),
            n
        },
        hooks: {
            all: {},
...
Prism.hooks.add("before-sanity-check", function(t) {
    if ((t.element.matches || t.element.msMatchesSelector).call(t.element, "script[type='text/plain']")) {
        ...
        return (a = document.createElement("pre")).className = e.className = t.element.className,
        t.element.dataset && Object.keys(t.element.dataset).forEach(function(e) {
